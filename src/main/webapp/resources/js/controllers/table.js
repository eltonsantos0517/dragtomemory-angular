materialAdmin.controller(
			...
			this.tableFilter = new ngTableParams({
				...
				getData : function($defer, params) {
					...
					this.email = orderedData.slice((params.page() - 1)
							* params.count(), params.page() * params.count());
					this.username = orderedData.slice((params.page() - 1)
							* params.count(), params.page() * params.count());
					this.contact = orderedData.slice((params.page() - 1)
							* params.count(), params.page() * params.count());
		...
		'userCtrl',
		function($filter, $sce, ngTableParams, tableService, $scope, crudService) {
