package com.obackend.base.controller;
...
import com.obackend.base.service.ItemService;
...
public class ItemController {
	...
	@Autowired
	ItemService itemService; // Service which will do all data
								// retrieval/manipulation work

	@RequestMapping(value = "/computers")
	public ResponseEntity<List> listAllComputers(@RequestHeader HttpHeaders headers) {
